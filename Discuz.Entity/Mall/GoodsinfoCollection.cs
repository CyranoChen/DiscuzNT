...
namespace Discuz.Entity
{
    ...
    {
    	/// <summary>
		/// Initializes a new instance of the <see cref="GoodsinfoCollection">GoodsinfoCollection</see> class.
		/// </summary>
		...
		/// <summary>
		/// Gets the <see cref="GoodsinfoCollection">GoodsinfoCollection</see> at the specified index in the collection.
		/// <para>
		/// In C#, this property is the indexer for the <see cref="GoodsinfoCollection">GoodsinfoCollection</see> class.
		/// </para>
		/// </summary>
        public Goodsinfo this[int index] 
		{
            get { return ((Goodsinfo)(this.List[index])); }
		}
		...
		/// <summary>
		/// Returns an enumerator that can iterate through the <see cref="GoodsinfoCollection">GoodsinfoCollection</see> instance.
		/// </summary>
		/// <returns>An <see cref="GoodsinfoCollectionEnumerator">GoodsinfoCollectionEnumerator</see> for the <see cref="GoodsinfoCollection">GoodsinfoCollection</see> instance.</returns>
		public new GoodsinfoCollectionEnumerator GetEnumerator()	
		{
			return new GoodsinfoCollectionEnumerator(this);
		}
		
		/// <summary>
		/// Supports a simple iteration over a <see cref="GoodsinfoCollection">GoodsinfoCollectio</see>.
		/// </summary>
		public class GoodsinfoCollectionEnumerator : IEnumerator	
		{
			...
			/// </summary>
			public Goodsinfo Current
			{
				get {return ((Goodsinfo)(_enumerator.Current));}
			}
