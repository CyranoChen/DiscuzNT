...
namespace Discuz.Entity
{
	...
	/// </summary>
	//[Serializable]
	public class OnlineUserInfoCollection: CollectionBase
	{

		/// <summary>
		/// Initializes a new instance of the <see cref="OnlineUserInfoCollection">OnlineUserInfoCollection</see> class.
		/// </summary>
		public OnlineUserInfoCollection() 
		{
		}
		...
		/// <summary>
		/// Gets the <see cref="OnlineUserInfoCollection">OnlineUserInfoCollection</see> at the specified index in the collection.
		/// <para>
		/// In C#, this property is the indexer for the <see cref="OnlineUserInfoCollection">OnlineUserInfoCollection</see> class.
		/// </para>
		/// </summary>
		public OnlineUserInfo this[int index] 
		{
			get	{return ((OnlineUserInfo)(this.List[index]));}
		}
		...
		/// <summary>
		/// Returns an enumerator that can iterate through the <see cref="OnlineUserInfoCollection">OnlineUserInfoCollection</see> instance.
		/// </summary>
		/// <returns>An <see cref="OnlineUserInfoCollectionEnumerator">OnlineUserInfoCollectionEnumerator</see> for the <see cref="OnlineUserInfoCollection">OnlineUserInfoCollection</see> instance.</returns>
		public new OnlineUserInfoCollectionEnumerator GetEnumerator()	
		{
			return new OnlineUserInfoCollectionEnumerator(this);
		}
		
		/// <summary>
		/// Supports a simple iteration over a <see cref="OnlineUserInfoCollection">OnlineUserInfoCollection</see>.
		/// </summary>
		public class OnlineUserInfoCollectionEnumerator : IEnumerator	
		{
			...
			/// </summary>
			public OnlineUserInfo Current
			{
				get {return ((OnlineUserInfo)(_enumerator.Current));}
			}
