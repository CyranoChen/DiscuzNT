<%@ Page language="c#" Inherits="Discuz.Web.Admin.hotfix" Codebehind="hotfix.aspx.cs" %>
		...
		<script type="text/javascript">
		    ...
		    function updateversion()
		    {
		        ...
		        for(var i = 0; i < versionList.length; i++)
		        {
		            ...
		            {
		                if(inputarray[j].type == "checkbox" && inputarray[j].checked && inputarray[j].value == versionList[i]["version"])
		                {
		                    var result = "";
		                    ...
		                    result = getReturn('ajaxupgrade.aspx?op=downupgradefile&upgradetype=optional&ver=' + versionList[i]["version"]);
		                    if(result != "")
		                    {
		                    ...
		                    result = getReturn('ajaxupgrade.aspx?op=downzip&upgradetype=optional&ver=' + versionList[i]["version"]);
		                    if(result != "")
		                    {
		                    ...
		                    result = getReturn('ajaxupgrade.aspx?op=runsql&step=1&ver=' + versionList[i]["version"] + "&optional=true");
		                    if(result != "")
		                    {
