<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="shortcutmenu.ascx.cs" Inherits="Discuz.Web.Admin.shortcutmenu" %>
<dl>
    <%=shortcutmenustr%>
    ...
    <dd><a href="http://www.discuznt.com/admindoc" target="_blank" onfocus="this.blur();">帮助</a></dd>    
