        ...
        <div class="ManagerForm">
            <fieldset>
                ...
                <table border="0" align="center">
                    <tr>
                        <td>可选版块：<br />
                            <cc1:ListBoxTreeList ID="list1" runat="server"></cc1:ListBoxTreeList>
                        </td>
                        <td>
                            <input type="button" value=">" onclick="move(this.form.<%=list1.TypeID.ClientID %>, this.form.list2, 0)" style="font-weight: bold; width: 32" />
                        </td>
                        <td>已选版块：<br />
                            <select multiple="multiple" size="8" id="list2" name="list2" style="width: 260px; height: 290px;"></select></td>
                        <td>
                            <input type="button" value="移至最前" onclick="firstOnClick(this.form.list2)" /><br />
                            <input type="button" value='上移一位' onclick="Up(this.form.list2)" /><br />
                            <br />
                            <input type="button" value='移除项目' onclick="DelteItem(this.form.list2)" /><br />
                            <br />
            ...
            <div align="center">
                ...
                <button class="ManagerButton" type="button" onclick="javascript:window.location.href='aggregation_recommendtopic.aspx';">
                    <img src="../images/submit.gif" />返回</button>
            </div>
        </div>
    </form>
    <%=footer%>
