<%@ Page Language="C#" CodeBehind="forum_smiliemanage.aspx.cs" Inherits="Discuz.Web.Admin.smiliemanage" %>
...
<cc1:datagrid id="smilesgrid" runat="server" IsFixConlumnControls="true">
	<Columns>
		...
		<asp:TemplateColumn HeaderText="操作">
			<ItemTemplate>
				<a href="forum_smilegrid.aspx?typeid=<%# DataBinder.Eval(Container, "DataItem.id").ToString() %>">管理此表情分类</a>
			</ItemTemplate>
		</asp:TemplateColumn>		
	</Columns>
</cc1:datagrid><br />
