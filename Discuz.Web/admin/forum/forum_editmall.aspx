<%@ Page Language="c#" Inherits="Discuz.Web.Admin.editmall" CodeBehind="forum_editmall.aspx.cs" %>
...
<form id="Form1" method="post" runat="server">
        <span style="font-size: 12px">当前商城版块为: <b>
            <asp:Literal ID="forumname" runat="server"></asp:Literal></b></span>
...
<table width="100%">
	<tr>
                        <td class="item_title" colspan="2">交易版名称</td>
                    </tr>
                    <tr>
	...
	<tr>
                        <td class="item_title" colspan="2">已继承的版主</td>
                    </tr>
                    <tr>
		<td class="vtop rowform">
	...
	<tr>
                        <td class="item_title" colspan="2">是否显示</td>
                    </tr>
                    <tr>
		<td class="vtop rowform">
	...
	-->
	<tr>
                        <td class="item_title" colspan="2">版主列表</td>
                    </tr>
                    <tr>
		<td class="vtop rowform">
	...
	<tr>
                        <td class="item_title" colspan="2">交易版描述</td>
                    </tr>
                    <tr>
		<td class="vtop rowform">
	...
	<tr>
                            <td class="item_title" colspan="2">模板风格</td>
                        </tr>
                        <tr>
		<td class="vtop rowform">
...
<table width="100%">
	<tr>
                        <td class="item_title" colspan="2">访问本版块的密码</td>
                    </tr>
                    <tr>
		<td class="vtop rowform">
	...
	<tr>
                        <td class="item_title" colspan="2">交易版图标</td>
                    </tr>
                    <tr>
		<td class="vtop rowform">
	...
	-->
	<tr>
                        <td class="item_title" colspan="2">指向外部链接地址</td>
                    </tr>
                    <tr>
		<td class="vtop rowform">
	...
	<tr>
                        <td class="item_title" colspan="2">允许的附件类型</td>
                    </tr>
                    <tr>
		<td class="vtop rowform">
	...
	<tr>
                        <td class="item_title" colspan="2">本版规则</td>
                    </tr>
                    <tr>
		<td class="vtop rowform">
	...
	-->
	<tr>
                        <td class="item_title" colspan="2">设置</td>
                    </tr>
                    <tr>
...
<cc2:TabPage Caption="权限设定" ID="tabPage3">
	...
	<tr>
		...
		<td class="td_alternating_item2" width="20%" style="word-wrap: break-word">&nbsp;</td>
                        <td class="td_alternating_item2">
                            <input type="checkbox" id="c1" onclick="seleCol('viewperm',this.checked)" /><label for="c1">浏览/交易商品</label></td>
                        <td class="td_alternating_item2">
                            <input type="checkbox" id="c2" onclick="seleCol('postperm',this.checked)" /><label for="c2">发布商品</label></td>
                        <td class="td_alternating_item2">
                            <input type="checkbox" id="c3" onclick="seleCol('replyperm',this.checked)" /><label for="c3">发表留言</label></td>
                        <td class="td_alternating_item2">
                            <input type="checkbox" id="c4" onclick="seleCol('getattachperm',this.checked)" /><label for="c4">下载/查看附件</label></td>
                        <td class="td_alternating_item2">
                            <input type="checkbox" id="c5" onclick="seleCol('postattachperm',this.checked)" /><label for="c5">上传附件</label></td>
	</tr>
</table>
</cc2:TabPage>
...
<table width="100%">
                    <tr>
                        <td class="item_title" colspan="2">增加特殊用户列表</td>
                    </tr>
	<tr>
		<td class="vtop" colspan="2">
...
<table width="100%">
                    <tr>
                        <td class="item_title" colspan="2">启用主题分类</td>
                    </tr>
	<tr>
		<td class="vtop rowform">
		...
		<td class="vtop">设置是否在本版块启用主题分类功能,您需要同时设定相应的分类选项,才能启用本功能</td>
                    ...
                    <tr>
                        <td class="item_title" colspan="2">发帖必须归类</td>
                    </tr>
	<tr>
		<td class="vtop rowform">
		...
		<td class="vtop">如果选择"是",作者发新主题时,必须选择主题对应的类别才能发表.本功能必须"启用主题分类"后才可使用</td>
                    ...
                    <tr>
                        <td class="item_title" colspan="2">允许按类别浏览</td>
                    </tr>
	<tr>
		<td class="vtop rowform">
		...
		<td class="vtop">如果选择"是",用户将可以在本论坛中按照不同的类别浏览主题.注意: 本功能必须"启用主题分类"后才可使用并会加重服务器负担</td>
                    ...
                    <tr>
                        <td class="item_title" colspan="2">类别前缀</td>
                    </tr>
	<tr>
		<td class="vtop rowform">
...
<Columns>
	<asp:BoundColumn DataField="id" HeaderText="id" Visible="false"></asp:BoundColumn>
                        <asp:BoundColumn DataField="name" HeaderText="主题分类">
                            <HeaderStyle Width="15%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="description" HeaderText="描述">
                            <HeaderStyle Width="40%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn HeaderText="不使用">
                            <HeaderStyle Width="15%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn HeaderText="使用(平板显示)">
                            <HeaderStyle Width="15%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn HeaderText="使用(下拉显示)">
                            <HeaderStyle Width="15%" />
                        </asp:BoundColumn>
</Columns>
                </cc2:DataGrid>
<table width="100%">
                    <tr>
                        <td class="item_title" colspan="2">主题分类名</td>
                    </tr>
	<tr>
		<td class="vtop rowform">
	...
	<tr>
		...
		<td class="vtop"></td>
                    ...
                    <tr>
                        <td class="item_title" colspan="2">描述</td>
                    </tr>
	<tr>
		<td class="vtop rowform">
		...
		<td class="vtop"></td>
                ...
                <div class="Navbutton">
                    <button type="button" class="ManagerButton" id="AddNewRec" onclick="AddTopicType();">
...
<cc2:TabPage Caption="统计信息" ID="tabPage6">
                ...
                <br />
	<br />
                <cc2:Button ID="RunForumStatic" runat="server" ButtontypeMode="Normal" Text="统计最新信息" />
	<%=runforumsstatic%>
</cc2:TabPage>	
</cc2:TabControl>
...
<table width="100%">
	...
	<tr>
		...
		<td class="vtop"></td>
                ...
                <tr>
                    <td class="item_title" colspan="2">主题分类</td>
                </tr>
	<tr>
		<td class="vtop rowform">
...
<div class="Navbutton">
            ...
            <button onclick="window.location='forum_forumstree.aspx';" id="Button3" class="ManagerButton" type="button">
