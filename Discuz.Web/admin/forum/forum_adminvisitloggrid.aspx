...
<table width="100%">
	<tr>
                        <td class="item_title" colspan="2">发生时间范围</td>
                    </tr>
                    <tr>
	...
	<tr>
                        <td class="item_title" colspan="2">搜索内容</td>
                    </tr>
                    <tr>
		<td class="vtop rowform">
	...
	<tr>
                        <td class="item_title" colspan="2">管理员名称</td>
                    </tr>
                    <tr>
		<td class="vtop rowform">
		...
		<td class="vtop">多用户名中间请用半角逗号 "," 分割</td>
                ...
                <div class="Navbutton">
                    <cc1:Button ID="SearchLog" runat="server" Text="开始搜索" ButtonImgUrl="../images/search.gif"></cc1:Button></div>
</fieldset>
</div>
...
&nbsp;&nbsp;<input type="radio" name="deleteMode" onclick="changeDeleteModeState(3, this.form)" value="deleteFrom" id="radio3">
            删除<cc4:Calendar ID="deleteFrom" runat="server" ReadOnly="True" ScriptPath="../js/calendar.js" Enabled="False"></cc4:Calendar>
            之前的记录
