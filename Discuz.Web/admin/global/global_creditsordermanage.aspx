<%@ Page Language="c#" Inherits="Discuz.Web.Admin.creditsordermanage" Codebehind="global_creditsordermanage.aspx.cs" %>
	...
	<table class="ntcplist">
	  ...
	  <table id="orderlist" class="datalist" rules="all" cellspacing="0" border="1" align="center" style=" border-collapse:collapse;">
	    <tbody>
	     ...
	     <%foreach (CreditOrderInfo order in orderList)
        {%>
	     <tr class="mouseoutstyle" onmouseout="this.className='mouseoutstyle'" onmouseover="this.className='mouseoverstyle'">
	        <td style="border: 1px solid rgb(234, 233, 225);"><%=order.OrderId%></td>
	        <td style="border: 1px solid rgb(234, 233, 225);"><%=order.TradeNo%></td>
	        <td style="border: 1px solid rgb(234, 233, 225);"><%=ConvertStatusNoToWord(order.OrderStatus)%></td>
	        ...
	        <td style="border: 1px solid rgb(234, 233, 225);"><%=Utils.GetStandardDateTime(order.CreatedTime, "yyyy-MM-dd HH:mm")%></td>
	        <td style="border: 1px solid rgb(234, 233, 225);"><%=Utils.GetStandardDateTime(order.ConfirmedTime,"yyyy-MM-dd HH:mm")%></td>
	     </tr>
	     <%}%>
	    </tbody>
	  </table>
