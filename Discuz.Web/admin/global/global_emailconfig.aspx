...
<fieldset>
	...
	<tr>
		<td class="vtop rowform">
			<cc1:dropdownlist id="smtpemail" runat="server" HintInfo="设置发送邮件的程序"></cc1:dropdownlist>
		</td>
		<td class="vtop">设置发送邮件的程序</td>
	</tr>
	</table>
	<div class="Navbutton">
		<cc1:Button id="SaveEmailInfo" runat="server" Text=" 提 交 "></cc1:Button>
	</div>
</fieldset>
<fieldset>
...
<tr>
	...
	<td class="vtop"><cc1:Button id="sendTestEmail" runat="server" Text=" 发送测试邮件 "></cc1:Button>设置要测试的邮箱地址,测试程序将发送一封邮件到测试邮箱中</td>
</tr>
</table>
</fieldset>
