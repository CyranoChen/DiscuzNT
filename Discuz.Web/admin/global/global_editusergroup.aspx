...
<table width="100%">
	...
	<tr>
		<td class="vtop rowform">
			  <a href="#" class="TextButton" onclick="javascript:window.location.href='global_allowparticipatescore.aspx?pagename=global_editusergroup&groupid=<%=Request.Params["groupid"]%>'">编辑评分范围</a>
		</td>
		<td class="vtop"></td>
	</tr>
</table>
