<%@ Page AutoEventWireup="false" Inherits="Discuz.Web.UI.HelpPage" %>
...
<div id="item1" style="border:0px; background-color:#ffffff; width:100%; margin:auto; padding:6px; display:none">
  <div>
      <ul>
        ...
        <li><a href="#1-2">Discuz!NT 论坛使用 Cookies 吗？</a> </li>
  ...
  <div>
    ...
    <div>    这取决于管理员如何设置 Discuz!NT 论坛的用户组权限选项，您甚至有可能必须在注册成正式用户后后才能浏览帖子。当然，在通常情况下，您至少应该是正式用户才能发新帖和回复已有帖子。请 <a href="../register.aspx">点击这里</a> 免费注册成为我们的新用户！<br />
        <br />
            
  ...
  <br />
  <div>
    <div><a name="#1-2" id="#1-2"></a><strong>Discuz!NT 论坛使用 Cookies 吗？</strong></div>
    <div>    Discuz!NT 采用 Cookie   的双重方式保存用户信息，以确保在各种环境，包括 Cookie 完全无法使用的情况下您都能正常使用论坛各项功能。但 Cookies   的使用仍然可以为您带来一系列的方便和好处，因此我们强烈建议您在正常情况下不要禁止 Cookie 的应用，Discuz!NT   的安全设计将全力保证您的资料安全。<br />
        <br />
          
  ...
  <div>
    ...
    <div>    Discuz!NT 提供发送取回密码链接到 Email 的服务，点击登录页面中的取回密码功能，可以为您把取回密码的方法发送到注册时填写的 Email   信箱中。如果您的 Email 已失效或无法收到信件，请与论坛管理员联系。 </div>
  </div>
  <br />
  <div>
...
<div id="item3" style="border:0px; background-color:#ffffff; width:100%; margin:auto; padding:6px; display:none">
  ...
  <div>
    ...
    <div>    Smilies 是一些用字符表示的表情符号，如果打开 Smilies 功能，Discuz!NT   会把一些符号转换成小图像，显示在帖子中，更加美观明了。</div>
  </div>
  <br />
  <div>
