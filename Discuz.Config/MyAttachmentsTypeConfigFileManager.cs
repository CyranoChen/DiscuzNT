...
namespace Discuz.Config
{
    ...
    /// 论坛基本设置管理类
    /// </summary>
    class MyAttachmentsTypeConfigFileManager : Discuz.Config.DefaultConfigFileManager
    {
        ...
        public new static string ConfigFilePath
        {
            get
            {
                if (filename == null)
                {
                    filename = Utils.GetMapPath(BaseConfigs.GetForumPath + "config/myattachment.config");
                }
